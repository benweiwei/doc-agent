export default {
  ...
  document: {
    ...
    rename: '重命名',
    delete: '删除',
    deleteConfirm: '确定要删除文档「{name}」吗？此操作会提交一次删除记录。',
    export: '导出',
  ...
  settings: {
    ...
    style: '风格配置',
    styleEnabled: '启用风格匹配',
    styleEnabledHint: '开启后，AI 编辑会自动注入你的行文习惯与所选风格模板',
    learnStyle: '从文档学习风格',
    relearnStyle: '重新学习',
    clearHabit: '清除',
    habitProfile: '个人行文习惯',
    habitLearned: '已学习',
    habitNone: '未学习',
    habitHint: '尚未学习。将分析工作区历史文档，提炼你的句长、用词、标点等习惯并注入 AI 编辑。',
    general: '通用',
    autoSave: '自动保存',
    save: '保存',
    saving: '保存中...',
